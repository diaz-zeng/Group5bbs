    ...
    <div id="admin">
        <div class="admin_lt">
            <ul>
                ...
                <li class="admin_mod">
                    <span class="md"><a href="comment-manage.html">评论管理</a><b>···</b></span>
                    <ul>
                        <li class="ml"><a href="comment-manage.html">评论审核</a></li>
                        <li class="ml"><a href="comment-pass.html">已审核评论</a></li>
                        <li class="ml"><a href="comment-loser.html">未通过评论</a></li>
                    </ul>
                </li>
                <li class="admin_mod">
                    <span class="md"><a>积分管理</a><b>···</b></span>
                    <ul>
                        <li class="ml"><a href="integral.html">积分查询</a></li>
                    </ul>
                </li>
            </ul>
        </div>
